...
public class BuggyControllerTests
{
    ...
    [Fact]
    public async Task GetSecretWithoutAuthorizationShouldReturnUnauthorized()
    {
        // Arrange
        requestUrl = $"{apiRoute}/auth";
    ...
    [Fact]
    public async Task GetSecretWithInvalidTokenShouldReturnUnauthorized()
    {
        // Arrange
    ...
    [Fact]
    public async Task SuccessfulLoginShouldReturnToken()
    {
        // Arrange
        requestUrl = "api/account/login";
        var loginRequest = new LoginRequest
